...
[task_local]
#进店领豆
40 0,22 * * * jd_shop.js, tag=进店领豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_shop.png, enabled=true
================Loon============
[Script]
cron "40 0,22 * * *" script-path=jd_shop.js,tag=进店领豆
==============Surge===============
[Script]
进店领豆 = type=cron,cronexp="40 0,22 * * *",wake-system=1,timeout=3600,script-path=jd_shop.js
*/
const $ = new Env('进店领豆');
